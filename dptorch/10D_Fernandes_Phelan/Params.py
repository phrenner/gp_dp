...
def dynamic_params(cfg):
    ...
    cfg["torch_optim"]["LR_vf"] = 1e-3
    cfg["torch_optim"]["LR_pol"] = 1e-3
    ...
    cfg["scipyopt"]["no_init_restarts"] = 6
    ...
    cfg["model"]["params"]["pen_deviation"] = 0.
    cfg["model"]["params"]["pen_vf"] = 1.0
    ...
    cfg["model"]["params"]["min_GP_value"] = cfg["model"]["params"]["lower_V"] - 0.01
    cfg["model"]["params"]["GP_offset"] = (cfg["model"]["params"]["min_GP_value"]) #translate the gp by this amount

    cfg["model"]["params"]["autarky_state"] = (torch.tensor([[6.62456, 7.08503, 7.70282, 8.34119, 8.9577, 9.54104, 10.0878, 10.5909, 11.0261, 11.3207]]))
    cfg["model"]["params"]["autarky_V"] = torch.tensor(0.)
