...
def dynamic_params(cfg):
    ...
    cfg["model"]["params"]["discrete_state_dim"] = 1
    ...
    cfg["model"]["params"]["GP_offset"] = torch.ones(n_types) * (cfg["model"]["params"]["lower_V"] - cfg["model"]["params"]["max_penalty"]) #/(1-beta) #translate the gp by this amount
