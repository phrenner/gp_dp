...
def dynamic_params(cfg):
    ...
    cfg["model"]["params"]["pen_opt_vf"] = 20.
    cfg["model"]["params"]["pen_vf"] = 1.00
    ...
    cfg["model"]["params"]["lower_V"] =  torch.tensor(-1.0)
    cfg["model"]["params"]["upper_V"] =  torch.tensor(0.05)
